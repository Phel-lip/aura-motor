...
export const metadata: Metadata = { title: 'Aura Essencial · Beleza para viver do seu jeito', description: 'Um espaço de cuidado, conversa boa e beleza sem pressa na Vila Madalena.', generator: 'Aura Essencial', robots: { index: false, follow: false } }
